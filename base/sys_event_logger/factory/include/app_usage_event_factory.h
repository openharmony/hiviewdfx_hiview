...
#ifndef HIVIEW_PLUGINS_SYS_EVENT_LOGGER_APP_USAGE_EVENT_FACTORY_H
#define HIVIEW_PLUGINS_SYS_EVENT_LOGGER_APP_USAGE_EVENT_FACTORY_H
...
class AppUsageEventFactory : public BaseEventFactory {
public:
...
#endif // HIVIEW_PLUGINS_SYS_EVENT_LOGGER_APP_USAGE_EVENT_FACTORY_H
