...
#ifndef HIVIEW_PLUGINS_SYS_EVENT_LOGGER_PARAM_VALUE_H
#define HIVIEW_PLUGINS_SYS_EVENT_LOGGER_PARAM_VALUE_H
...
#endif // HIVIEW_PLUGINS_SYS_EVENT_LOGGER_PARAM_VALUE_H
