...
#ifndef HIVIEW_PLUGINS_SYS_EVENT_LOGGER_HIVIEW_SHUTDOWN_CALLBACK_STUB_H
#define HIVIEW_PLUGINS_SYS_EVENT_LOGGER_HIVIEW_SHUTDOWN_CALLBACK_STUB_H
...
#endif // HIVIEW_PLUGINS_SYS_EVENT_LOGGER_HIVIEW_SHUTDOWN_CALLBACK_STUB_H
