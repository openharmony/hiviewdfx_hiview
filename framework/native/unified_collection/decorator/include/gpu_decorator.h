...
#ifndef HIVIEW_FRAMEWORK_NATIVE_UNIFIED_COLLECTION_GPU_DECORATOR_H
#define HIVIEW_FRAMEWORK_NATIVE_UNIFIED_COLLECTION_GPU_DECORATOR_H
...
private:
    std::shared_ptr<GpuCollector> gpuCollector_;
    static StatInfoWrapper statInfoWrapper_;
};
} // namespace UCollectUtil
} // namespace HiviewDFX
} // namespace OHOS
#endif // HIVIEW_FRAMEWORK_NATIVE_UNIFIED_COLLECTION_GPU_DECORATOR_H
