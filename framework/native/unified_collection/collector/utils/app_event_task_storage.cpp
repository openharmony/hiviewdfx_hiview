...
bool InnerCreateAppTaskTable(std::shared_ptr<NativeRdb::RdbStore> dbStore)
{
     ...
     * |-----|-----------|-----------|-------|-------|-------------|----------------|------------|-------------|---------------|---------------|----------|-------|
     * |  id | task_date | task_type | uid   | pid   | bundle_name | bundle_version | start_time | finish_time | resource_path | resource_size | cost_cpu | state |
     * |-----|-----------|-----------|-------|-------|-------------|----------------|------------|-------------|---------------|---------------|----------|-------|
     * | INT |   INT64   |    INT8   | INT32 | INT32 |      TEXT   | TEXT           |  INT64     | INT64       | TEXT          | INT32         | REAL     | INT32 |
     * |-----|-----------|-----------|-------|-------|-------------|----------------|------------|-------------|---------------|---------------|----------|-------|
     */
