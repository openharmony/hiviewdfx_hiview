...
const std::list<std::pair<std::string, MemoryItemType>> PREFIX_LIST = {
    ...
    {"[anon:native_heap:other]", MemoryItemType::MEMORY_ITEM_TYPE_ANON_NATIVE_HEAP_OTHER},
    ...
    {"[anon:guard", MemoryItemType::MEMORY_ITEM_TYPE_GUARD},
    ...
    {"[unknown", MemoryItemType::MEMORY_ITEM_TYPE_UNKOWN},
...
const std::map<MemoryItemType, MemoryClass> TYPE_TO_CLASS_MAP = {
    ...
    {MemoryItemType::MEMORY_ITEM_TYPE_ANON_ARKTS_HEAP, MemoryClass::MEMORY_CLASS_ARK_TS_HAP},
    ...
    {MemoryItemType::MEMORY_ITEM_TYPE_UNKOWN, MemoryClass::MEMORY_CLASS_OTHER},
