...
#define PARAM_BUNDLE_NAME_LITERAL "BUNDLE_NAME"
#define PARAM_BUNDLE_VERSION_LITERAL "BUNDLE_VERSION"
#define PARAM_BEGIN_TIME_LITERAL "BEGIN_TIME"
#define PARAM_END_TIME_LITERAL "END_TIME"
#define PARAM_THREAD_NAME_LITERAL "THREAD_NAME"
#define PARAM_FOREGROUND_LITERAL "FOREGROUND"
#define TRACE_DUMP_CODE_LITERAL "TRACE_DUMP_CODE"
#define PARAM_EXTERNAL_LOG_LITERAL "EXTERNAL_LOG"
#define PARAM_JANK_LEVEL_LITERAL "JANK_LEVEL"
constexpr char SYS_EVENT_PARAM_BUNDLE_NAME[] = PARAM_BUNDLE_NAME_LITERAL;
constexpr char SYS_EVENT_PARAM_BUNDLE_VERSION[] = PARAM_BUNDLE_VERSION_LITERAL;
constexpr char SYS_EVENT_PARAM_BEGIN_TIME[] = PARAM_BEGIN_TIME_LITERAL;
constexpr char SYS_EVENT_PARAM_END_TIME[] = PARAM_END_TIME_LITERAL;
constexpr char SYS_EVENT_PARAM_JANK_LEVEL[] = PARAM_JANK_LEVEL_LITERAL;
constexpr char SYS_EVENT_TRACE_DUMP_CODE[] = TRACE_DUMP_CODE_LITERAL;
constexpr char SYS_EVENT_PARAM_EXTERNAL_LOG[] = PARAM_EXTERNAL_LOG_LITERAL;
constexpr char SYS_EVENT_PARAM_THREAD_NAME[] = PARAM_THREAD_NAME_LITERAL;
constexpr char SYS_EVENT_PARAM_FOREGROUND[] = PARAM_FOREGROUND_LITERAL;
