...
public:
    ...
    virtual CollectResult<std::vector<std::string>> DumpSnapshot(Caller caller) override;
...
CollectResult<std::vector<std::string>> TraceCollectorImpl::DumpSnapshot(Caller caller)
{
