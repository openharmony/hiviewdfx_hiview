...
void EventSourceExample::OnLoad()
{
    ...
    std::string folderPath = "/data/test/faultlog";
    ...
    CreateWatchFile("/data/test/faultlog/aaa");
    CreateWatchFile("/data/test/faultlog/bbb");
    CreateWatchFile("/data/test/faultlog/ccc");
}
...
void EventSourceExample::CreateAndPublishEvent(const std::string &file)
{
    ...
    if (file == "/data/test/faultlog/aaa") {
        event->eventId_ = PIPELINE_EVENT_ID_AAA;
    } else if (file == "/data/test/faultlog/bbb") {
        event->eventId_ = PIPELINE_EVENT_ID_BBB;
    } else if (file == "/data/test/faultlog/ccc")  {
