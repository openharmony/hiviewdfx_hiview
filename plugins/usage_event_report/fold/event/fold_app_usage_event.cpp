    ...
    : LoggerEvent(name, type)
{
    this->paramMap_ = {
        ...
        {KEY_OF_FOLD_VER_SPLIT_USAGE, DEFAULT_UINT32}, {KEY_OF_FOLD_HOR_SPLIT_USAGE, DEFAULT_UINT32},
        {KEY_OF_FOLD_VER_FLOATING_USAGE, DEFAULT_UINT32}, {KEY_OF_FOLD_HOR_FLOATING_USAGE, DEFAULT_UINT32},
        {KEY_OF_FOLD_VER_MIDSCENE_USAGE, DEFAULT_UINT32}, {KEY_OF_FOLD_HOR_MIDSCENE_USAGE, DEFAULT_UINT32},
        {KEY_OF_EXPD_VER_USAGE, DEFAULT_UINT32}, {KEY_OF_EXPD_HOR_USAGE, DEFAULT_UINT32},
        {KEY_OF_EXPD_VER_SPLIT_USAGE, DEFAULT_UINT32}, {KEY_OF_EXPD_HOR_SPLIT_USAGE, DEFAULT_UINT32},
        {KEY_OF_EXPD_VER_FLOATING_USAGE, DEFAULT_UINT32}, {KEY_OF_EXPD_HOR_FLOATING_USAGE, DEFAULT_UINT32},
        {KEY_OF_EXPD_VER_MIDSCENE_USAGE, DEFAULT_UINT32}, {KEY_OF_EXPD_HOR_MIDSCENE_USAGE, DEFAULT_UINT32},
        {KEY_OF_G_VER_FULL_USAGE, DEFAULT_UINT32}, {KEY_OF_G_HOR_FULL_USAGE, DEFAULT_UINT32},
        {KEY_OF_G_VER_SPLIT_USAGE, DEFAULT_UINT32}, {KEY_OF_G_HOR_SPLIT_USAGE, DEFAULT_UINT32},
        {KEY_OF_G_VER_FLOATING_USAGE, DEFAULT_UINT32}, {KEY_OF_G_HOR_FLOATING_USAGE, DEFAULT_UINT32},
        {KEY_OF_G_VER_MIDSCENE_USAGE, DEFAULT_UINT32}, {KEY_OF_G_HOR_MIDSCENE_USAGE, DEFAULT_UINT32},
