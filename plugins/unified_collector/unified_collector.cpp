...
const std::string DEVELOPER_MODE_TRACE_ARGS = "tags:sched,freq,disk,sync,binder,mmc,membus,load,pagecache,workq,ipa,\
    hdf,virse,net,dsched,graphic,multimodalinput,dinput,ark,ace,window,zaudio,daudio,zmedia,dcamera,zcamera,dhfwk,app,\
    gresource,ability,power,samgr,ffrt clockType:boot1 bufferSize:1024 overwrite:0 fileLimit:20 fileSize:102400";
