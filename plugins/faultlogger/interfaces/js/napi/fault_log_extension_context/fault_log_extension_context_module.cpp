...
extern const char _binary_fault_log_extension_context_js_start[];
extern const char _binary_fault_log_extension_context_js_end[];
...
{
    if (buf != nullptr) {
        *buf = _binary_fault_log_extension_context_js_start;
    }

    if (bufLen != nullptr) {
        *bufLen = _binary_fault_log_extension_context_js_end -
            _binary_fault_log_extension_context_js_start;
    }
}
...
{
    if (buf != nullptr) {
        *buf = _binary_fault_log_extension_context_abc_start;
    }
    if (buflen != nullptr) {
        *buflen = _binary_fault_log_extension_context_abc_end -
            _binary_fault_log_extension_context_abc_start;
    }
}
