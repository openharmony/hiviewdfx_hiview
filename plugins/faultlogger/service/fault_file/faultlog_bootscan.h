...
namespace OHOS {
namespace HiviewDFX {
class FaultLogBootScan : public EventListener {
public:
    FaultLogBootScan(std::shared_ptr<EventLoop> workLoop, std::shared_ptr<FaultLogManager> faultLogManager);
    ~FaultLogBootScan() override = default;
...
private:
    ...
    bool IsReported(const FaultLogInfo& info);
