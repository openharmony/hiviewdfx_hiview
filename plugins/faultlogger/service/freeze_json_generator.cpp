...
FreezeJsonParams::Builder& FreezeJsonParams::Builder::InitRuntimeId(long runtimeId)
{
...
std::string FreezeJsonParams::JsonStr() const
{
    ...
    list.push_back(FreezeJsonUtil::GetStrByKeyValue(jsonParamsRuntimeId, runtimeId_));
