...
constexpr const char * const BUSIEST_STACK_COUNT = "BUSIEST_STACK_COUNT";
constexpr const char * const BUSIEST_STACK_RATIO_PERMILLE = "BUSIEST_STACK_RATIO_PERMILLE";
constexpr const char * const STACK_SOURCE = "STACK_SOURCE";
constexpr const char * const HAS_MAIN_THREAD_STACK = "HAS_MAIN_THREAD_STACK";
constexpr const char * const HEAVIEST_STACK_STATUS = "HEAVIEST_STACK_STATUS";
constexpr const char * const LOG_VALIDITY = "LOG_VALIDITY";
constexpr const char * const LOG_INVALID_REASON = "LOG_INVALID_REASON";
constexpr const char * const SAMPLER_COUNT = "SAMPLER_COUNT";
