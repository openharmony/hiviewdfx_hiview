...
const char * const FAULTLOG_WARNING_LOG_FOLDER = "/data/log/warninglog/";
...
constexpr const char * const FOCUS_MODE = "FOCUS_MODE"; // scene mode params,0:default;16:normal;32:max endurance;64:outside...
