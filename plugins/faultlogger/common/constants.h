...
constexpr int32_t MAX_FAULT_INFO_IN_MEM = 1000; // 1000 : log count
constexpr int32_t MAX_FAULT_LOG_PER_HAP = 100; //  100 : log count per hap
constexpr int32_t MAX_FAULTLOG_STORAGE_SIZE = 1024 * 1024 * 50; // 50M
}
}  // namespace HiviewDFX
}  // namespace OHOS
