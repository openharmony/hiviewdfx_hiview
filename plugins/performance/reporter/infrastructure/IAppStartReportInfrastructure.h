 ...
 */
#ifndef I_APP_START_REPORTER_INFRASTRUCTURE_H
#define I_APP_START_REPORTER_INFRASTRUCTURE_H

#include <string>

struct AppStartReportData {
    int32_t appPid{0};
...
class IAppStartReportInfrastructure {
public:
    virtual void ReportNormal(const AppStartReportData& data) = 0;
    virtual void ReportFault(const AppStartReportData& data) = 0;
};
#endif