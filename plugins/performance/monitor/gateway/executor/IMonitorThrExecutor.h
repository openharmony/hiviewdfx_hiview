 ...
 */
#ifndef I_MONITOR_THR_EXECUTOR_H
#define I_MONITOR_THR_EXECUTOR_H
...
public:
    ...
    public:
        virtual void HandleMainThrEvt(std::shared_ptr <XperfEvt> evt) = 0;
        virtual ~IHandleMonitorEvt() = default;
    };
